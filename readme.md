...
существует бесплатные альтернативы и решения. В частности, я использовал решение от localtunnel.me. При желании, [серверную часть](https://github.com/localtunnel/server) localtonnel можно установить на свой VPS, чтобы не отправлять запросы на loca.lt.
