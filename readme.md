...
существует бесплатные альтернативы и решения. В частности, я использовал решение от localtunnel.me. При желании, серверную часть localtonnel можно установить на свой VPS, чтобы не отправлять запросы на loca.lt.
